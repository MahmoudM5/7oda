...
sudo_users = {SUDO,1593178008,1602018563,1499701425}   
...
var = true  
elseif tonumber(user_id) == tonumber(1602018563) then
var = true  
...
function sendAudio(chat_id,reply_id,audio,title,caption)  
tdcli_function({ID="SendAudio",  chat_id_ = chat_id,  reply_to_message_id_ = reply_id,  disable_notification_ = 0,  from_background_ = 1,  reply_markup_ = nil,  input_message_content_ = {  ID="InputMessageAudio",  audio_ = GetInputFile(audio),  duration_ = '',  title_ = title or '',  performer_ = '',  caption_ = caption or ''  }},dl_cb,nil)
end  
...
if text == 'حودا مطور السورس' and SudoBot(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
sendAudio(msg.chat_id_,msg.id_,'https://t.me/d7kaya0/864')  
end
...
if result.sender_user_id_ == tonumber(1602018563) then
send(msg.chat_id_, msg.id_, " ⚝ لا يمكنك حظر مطور السورس \n")
return false 
end
