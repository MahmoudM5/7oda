...
if Text and Text:match('(.*)/help1') and SudoBot(tahaj) then
...
if Text and Text:match('(.*)/help2') and SudoBot(tahaj) then
...
if Text and Text:match('(.*)/help') and SudoBot(tahaj) then
