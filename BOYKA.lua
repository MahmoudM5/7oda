...
sudo_users = {SUDO,1593178008,1312558822,1499701425}   
...
elseif tonumber(user_id) == tonumber(1499701425) then
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(1496186391) then
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(1312558822) then
var = 'التوب'
elseif tonumber(user_id) == tonumber(SUDO) then
...
if result.sender_user_id_ == tonumber(1312558822) then
send(msg.chat_id_, msg.id_, " ⚝ لا يمكنك حظر مطور السورس \n")
return false 
end
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," ⚝ نسبه جمالك ~⪼ "..result.total_count_.." %", msg.id_, msg.id_, "num")
else
send(msg.chat_id_, msg.id_,'لا تمتلك صوره في حسابك', 1, 'num')
...
if Text and Text:match('(.*)/help1') and SudoBot(msg) then
...
if text and text:match('(.*)/help2') and SudoBot(msg) then
...
if text and text:match('(.*)/help3') and Owner(msg) then
...
if text and text:match('(.*)/help4') and Constructor(msg) then
...
if text and text:match('(.*)/help5') and DevBot(msg) then
...
if text and text:match('(.*)/help') and SudoBot(msg) then
...
elseif text and text:match('(.*)/lock_links') and SudoBot(data) then
...
elseif text and text:match('(.*)/lockwelcome') and SudoBot(data) then
...
elseif text and text:match('(.*)/unlock_links') and SudoBot(data) then
...
elseif text and text:match('(.*)/unlockwelcome') and SudoBot(data) then
...
if text and text:match('(.*)/lockjoine') and SudoBot(data) then
...
elseif text and text:match('(.*)/lockchat') and Owner(msg) then
...
elseif text and text:match('(.*)/lock_joine') and SudoBot(data) then
...
elseif text and text:match('(.*)/lockbots') and SudoBot(data) then
...
elseif text and text:match('(.*)/locktags') and SudoBot(data) then
...
elseif text and text:match('(.*)/lockedit') and Owner(msg) then
...
elseif text and text:match('(.*)/locklink') and SudoBot(data) then
...
elseif text and text:match('(.*)/lockusername') and SudoBot(data) then
...
elseif text and text:match('(.*)/locksticar') and SudoBot(data) then
...
elseif text and text:match('(.*)/lockgif') and SudoBot(data) then
...
elseif text and text:match('(.*)/lockvideo') and SudoBot(data) then
...
elseif text and text:match('(.*)/lockphoto') and SudoBot(data) then
...
elseif text and text:match('(.*)/lockvoise') and SudoBot(data) then
...
elseif text and text:match('(.*)/lockaudo') and SudoBot(data) then
...
elseif text and text:match('(.*)/lockfwd') and SudoBot(data) then
...
elseif text and text:match('(.*)/lockfile') and SudoBot(data) then
...
elseif text and text:match('(.*)/lockphone') and SudoBot(data) then
...
elseif text and text:match('(.*)/lockposts') and SudoBot(data) then
...
elseif text and text:match('(.*)/lockflood') and SudoBot(data) then
...
elseif text and text:match('(.*)/lockfarse') and SudoBot(data) then
...
elseif text and text:match('(.*)/lockfshar') and SudoBot(data) then
...
elseif text and text:match('(.*)/lockinlene') and SudoBot(data) then
...
if text and text:match('(.*)/unlockjoine') and SudoBot(data) then
...
elseif text and text:match('(.*)/unlock_joine') and SudoBot(data) then
...
elseif text and text:match('(.*)/unlockbots') and SudoBot(data) then
...
elseif text and text:match('(.*)/unlocktags') and SudoBot(data) then
...
elseif text and text:match('(.*)/unlocklink') and SudoBot(data) then
...
elseif text and text:match('(.*)/unlockusername') and SudoBot(data) then
...
elseif text and text:match('(.*)/unlocktag') and SudoBot(data) then
...
elseif text and text:match('(.*)/unlocksticar') and SudoBot(data) then
...
elseif text and text:match('(.*)/unlockgif') and SudoBot(data) then
...
elseif text and text:match('(.*)/unlockvideo') and SudoBot(data) then
...
elseif text and text:match('(.*)/unlockphoto') and SudoBot(data) then
...
elseif text and text:match('(.*)/unlockvoise') and SudoBot(data) then
...
elseif text and text:match('(.*)/unlockaudo') and SudoBot(data) then
...
elseif text and text:match('(.*)/unlockfwd') and SudoBot(data) then
...
elseif text and text:match('(.*)/unlockfile') and SudoBot(data) then
...
elseif text and text:match('(.*)/unlockphone') and SudoBot(data) then
...
elseif text and text:match('(.*)/unlockposts') and SudoBot(data) then
...
elseif text and text:match('(.*)/unlockflood') and SudoBot(data) then
...
elseif text and text:match('(.*)/unlockfarse') and SudoBot(data) then
...
elseif text and text:match('(.*)/unlockfshar') and SudoBot(data) then
...
elseif text and text:match('(.*)/unlockinlene') and SudoBot(data) then
...
elseif text and text:match('(.*)/homelocks') and SudoBot(data) then
