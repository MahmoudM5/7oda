...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MahmoudM2/7oda/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1593178008,1312558822,1496186391}   
...
os.execute('wget https://raw.githubusercontent.com/MahmoudM2/7oda/master/BOYKA.lua')
...
if text == 'محمود مطور السورس' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
local inline = {{{text="مـطـور الـبـوت ✓",url="t.me/MahmoudM2"}}}
send_inline_key(msg.sender_user_id_,text,nil,inline,msg.id_)
return false
end
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MahmoudM2/7oda/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/MahmoudM2/7oda/master/File_Bot/"..file)
if res == 200 then
